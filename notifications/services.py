...
class NotificationService:
    ...
    @staticmethod
    def send_email_notification(member, subject, text_content, html_content=None, notification_type=NotificationType.GENERAL, subscription=None):
    ...
    def send_membership_expiry_notification(cls, subscription, days_before_expiry):
        ...
        try:
            ...
            html_content = cls.render_template(template.body_html, context) if template.body_html else None
