...
class TestRunner:
    ...
    def run_linting_tests(self):
        ...
        try:
            ...
            if result.returncode == 0:
                ...
                self.test_results['linting'] = {'python': 'FAILED', 'issues': issues, 'output': result.stdout}
    ...
    def generate_summary(self):
        ...
        if 'api_tests' in self.test_results and 'statistics' in self.test_results['api_tests']:
            ...
            print(f"API Tests: {api_stats['passed']}/{api_stats['total']} passed ({api_stats['success_rate']:.1f}%)")
